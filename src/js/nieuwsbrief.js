document.addEventListener('DOMContentLoaded', function() {
    ...
    const formContent = document.getElementById('newsletterFormContent');
    ...
    // Verwijder foutmelding zodra gebruiker weer typt
    ...
    // Geüpdatete animatie met de specifieke kleur #4E9D3A
